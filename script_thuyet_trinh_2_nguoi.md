...
**Người trình bày chính: Ấn.** **Điền tiếp nhận phần còn lại và demo.**
...
- **Ấn nói liền mạch:** slide 1–12, gồm mở đầu, bài toán, dữ liệu, pipeline, thiết lập và kết quả tổng quan.
- **Điền nói liền mạch:** slide 13–19, gồm phân tích sâu, toàn bộ demo, hướng phát triển và kết luận.
- Chỉ có một lần chuyển người sau slide 12, không xen kẽ giữa các slide.
...
**Slide 2 — Ấn:** “Đầu vào là câu hỏi và văn bản OCR, đầu ra là đáp án ngắn như tổng tiền hoặc ngày. OCR sai có thể làm đáp án sai dù câu hỏi không đổi.”

**Slide 3 — Ấn:** “Hóa đơn sạch có tổng tiền 125.000 đồng; OCR nhiễu thành 125 OOO d. Sai một ký tự ở trường tiền có thể đổi đáp án.”
...
**Slide 6–9 — Ấn:** “Pipeline đi từ OCR sạch sang sinh nhiễu, train ba phương pháp và đánh giá trên cùng test set. 14 nhiễu gồm sai ký tự, mất thông tin, cấu trúc và trường quan trọng. Mô hình là ViT5-base, full data, 3 epoch, ANLS tại L2.”
...
**Chuyển người sau slide 12 — Ấn:** “Tiếp theo, Điền sẽ phân tích sâu, demo đường đi từ cấu hình đến biểu đồ và trình bày phần kết luận.”
...
**Điền mở đầu:** “Checkout không còn checkpoint nên nhóm không demo inference từng hóa đơn. Demo này truy vết cấu hình, CSV và biểu đồ đã lưu.”
...
**Điền kết thúc:** “Demo xác nhận đường đi cấu hình → CSV → biểu đồ. Đây là demo tái lập phân tích, không phải inference trực tiếp.”

**Slide 16–18 — Điền:** “Ưu tiên tiếp theo là equal-budget run, prediction từng mẫu, bootstrap confidence interval và phân tích money/mixed. Adapter Only và RON-NACA mới là hướng mở rộng, chưa chạy. Đóng góp hiện tại là benchmark ViT5 và 14 nhiễu OCR có kiểm soát.”
